...
def kapsam_tablosu():
    ...
    return (f'<div class="tablo-sar"><table class="kapsam-tablo">'
            f'<caption class="sr">Zarar kalemine göre DASK ve konut poliçesi kapsamı</caption>'
...
<script type="module">
  ...
  danismaBaslat(); aiSohbetBaslat(); sahneBaslat();
</script>
</body>
</html>
"""
...
def police_sayfasi(site, x):
  ...
  <div class="yazi-duzen">
    ...
    site.sayfa(
        ...
        aciklama=x.get("seoAciklama", x["ozet"]), govde=govde, aktif="police",
