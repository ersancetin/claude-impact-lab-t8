...
her `docs/` değişikliğinde çalışıyor. Ancak **Pages'in ilk kez açılması elle
yapılmalı** — Actions token'ı Pages sitesi *oluşturma* yetkisine sahip değil
...
`https://saidsurucu.github.io/claude-impact-lab-1-t8-hasar-tespiti/`

> ⚠️ **Depo şu an private.** Private depolarda GitHub Pages yalnızca ücretli
> planlarda (Pro / Team / Enterprise) kullanılabilir. Ücretsiz planda ya depoyu
