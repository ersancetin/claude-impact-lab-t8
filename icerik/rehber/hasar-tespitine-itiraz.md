{
  "id": "hasar-tespitine-itiraz",
  "kategori": "hasar-tespit",
  "sira": 2,
  "baslik": "Hasar tespit raporuna itiraz nasıl yapılır? 30 günlük süre ve dilekçe",
  "seoBaslik": "Hasar Tespit Raporuna İtiraz: 30 Günlük Süre",
  ...
  "seoAciklama": "Hasar tespit raporuna itiraz süresi 30 gündür ve mahallî ilan tarihinden başlar. İtiraz nereye, nasıl yapılır, dilekçede ne yazmalı? Adım adım anlatım.",
  "nitelik": "kalici",
  "dogrulama": "coklu",
  "guncelleme": "2026-08-15",
  "sure": "30 gün — hasar tespit sonucunun mahallî ilan tarihinden itibaren. Süre geçerse idari itiraz hakkı tamamen kaybedilir, geriye yalnızca yargı yolu kalır.",
  "dayanaklar": [
    {
      "ad": "7269 sayılı Umumi Hayata Müessir Afetler Kanunu",
      "aciklama": "Hasar tespiti ve itiraz"
    },
    {
      "ad": "Afet Sebebiyle Hak Sahibi Olanların Tespiti Hakkında Yönetmelik",
      "aciklama": "Hasar tespiti sonucuna itiraz usulünü ve ilan esasını düzenler."
    },
    {
      "ad": "2577 sayılı İdari Yargılama Usulü Kanunu",
      "aciklama": "Kesin tespit sonrası yargı yolu"
    }
  ],
  "sss": [
    {
      "soru": "Hasar tespit raporuna itiraz süresi ne zaman başlar?",
      "cevap": "Süre, raporun size elden tebliğ edildiği tarihte değil, sonucun mahallinde ilan edildiği tarihte başlar. Raporlar 30 gün süreyle askıda kalır; itiraz da bu 30 günlük süre içinde yapılır."
    },
    {
      "soru": "Hasar tespiti itirazı nereye yapılır?",
      "cevap": "İl Çevre, Şehircilik ve İklim Değişikliği Müdürlüğüne; valilik veya kaymakamlık evrak birimine; afet bölgelerinde kurulan Hasar Tespit İtiraz ve Koordinasyon Merkezlerine yapılabilir. Varsa e-Devlet başvuru adımı da kullanılabilir."
    },
    {
      "soru": "İtiraz sonrası yapılan tespit değiştirilebilir mi?",
      "cevap": "Hayır. İtiraz üzerine yapılan hasar tespiti kesindir ve idari yolla üçüncü bir tespit yapılmaz. Bu tespite katılmıyorsanız kalan tek yol idari yargıda dava açmaktır."
    },
    {
      "soru": "Binam hiç incelenmediyse ne yapmalıyım?",
      "cevap": "Hiç tespit yapılmamış olması da itiraz konusudur. Dilekçenizde binanın adresini, ada ve parselini belirterek hasar tespiti yapılmasını talep edebilirsiniz."
    },
    {
      "soru": "Kiracı hasar tespitine itiraz edebilir mi?",
      "cevap": "Uygulamada itiraz genellikle malik, hissedar veya kanuni temsilci tarafından yapılır. Kiracı olarak binayla ilişkinizi belirterek başvurabilir, malikle birlikte hareket edebilir ve kendi zararınız için ayrıca tazminat yoluna gidebilirsiniz."
    }
  ],
  "arac": [
    {
      "id": "dilekce",
      "ad": "Dilekçe üretici",
      "ozet": "Hazır şablonu doldurun, çıktı alıp imzalayın."
    },
    {
      "id": "sureler",
      "ad": "Süre takvimi",
      "ozet": "Ilan tarihini girin, kaç gününüz kaldığını görün."
    }
  ],
  "ilgili": [
...
:tablo Hasar dereceleri ve sonuçları
...
1. **İl Çevre, Şehircilik ve İklim Değişikliği Müdürlüğü** — elden, imza karşılığı.
2. **Valilik veya kaymakamlık evrak birimi.**
3. Afet bölgelerinde kurulan **Hasar Tespit İtiraz ve Koordinasyon Merkezleri.**
4. Varsa **e-Devlet** üzerindeki ilgili başvuru adımı.

:::uyari Kaydını saklayın
...
Bu içeriği elle yazmak zorunda değilsiniz: [hasar tespiti itiraz dilekçesi şablonu](../arac/dilekce.html?sablon=hasar-itiraz) hazır metindir; siz yalnızca kendi bilgilerinizi doldurursunuz ve çıktı tarayıcınızda oluşur, hiçbir yere gönderilmez.
...
:dayanak 2577 sayılı Kanun m.10-11
...
Bu ikilemi kimse size söylemiyorsa, bilerek karar verin: [hasarlı binadan eşya alma kuralları](hasarli-binadan-esya-alma.html).

## Bu itiraz, DASK itirazı değildir

İki süreç sürekli karıştırılıyor:

:tablo Hasar tespiti ile DASK sürecinin karşılaştırması
...
İkisi birbirinin yerine geçmez; ikisine de ayrı ayrı itiraz edilir. DASK tarafı için: [eksper raporuna itiraz](eksper-raporuna-itiraz.html).
